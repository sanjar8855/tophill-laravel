                            ...
                            <div class="col-lg-4 col-md-6">
                                <div class="banner-item img-hover-effect">
                                    <div class="banner-img img-zoom-effect">
                                        <img class="img-full" src="{{Storage::url('assets/images/subcategory/').$subcategory->photo}}" alt="Banner Image">
                                        <div class="product-content text-white">
                                            ...
                                            <div class="button-wrap">
                                                <a class="btn btn-custom-size btn-primary" href="{{route('ichkikategoriya',['id'=>$subcategory->id])}}">{{ __('words.Read more') }}</a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
