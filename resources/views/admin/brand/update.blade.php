        ...
        <div class="col-12 card">
            ...
            <div class="card-body">
                ...
                <form action="{{route('brands.update', ['brand' => $brand->id])}}" method="post" enctype="multipart/form-data">
                    ...
                    @csrf
                    <div class="">
                        <label class="form-label" for="name">Hamkor nomi</label>
                        <input type="text" class="form-control border border-radius-md ps-2" id="name" name="name" value="{{ $brand->name }}">
                    </div>
                    <div class="my-3">
                        <input type="file" class="form-control border" name="photo" files="{{ $brand->photo }}">
                    </div>
                    <div class="my-3">
                        <label class="form-label" for="description">Izoh</label>
                        <input type="text" class="form-control border border-radius-md ps-2" id="description" name="description" value="{{ $brand->description }}">
                    </div>
