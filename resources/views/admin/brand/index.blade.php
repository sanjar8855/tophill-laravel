          ...
          <div class="card my-4">
            <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
              <div class="bg-gradient-primary shadow-primary border-radius-lg pt-4 pb-3">
                <h6 class="text-white text-capitalize ps-3">Hamkorlar jadvali</h6>
              </div>
            </div>
            <div class="card-body px-0 pb-2">
                ...
                <table class="table align-items-center mb-0">
                  ...
                  <tbody>
                    ...
                    <tr>
                        <td>
                            <p class="font-weight-bold mb-0">{{(($brands->currentpage()-1) *  $brands->perpage() + ($loop->index +1)) }}</p>
                        </td>
                      <td>
                        <p class="font-weight-bold mb-0">{{$brand->name}}</p>
                      </td>
                        <td>
                            <div class="d-flex px-2 py-1">
                                <img src="{{Storage::url('assets/images/brand/').$brand->photo}}" class="me-3 shadow border-radius-lg" style="width: 200px;" alt="{{$brand->name}}">
                            </div>
                        </td>
                        <td>
                            <p class="font-weight-bold mb-0">{{$brand->description}}</p>
                        </td>
                        ...
                        <td class="align-middle d-flex justify-content-evenly">
                            <a href="{{ route('brands.show', ['brand' => $brand->id] )}}" class="btn btn-sm btn-outline-info mb-0" data-toggle="tooltip" data-original-title="Edit user">
                                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-eye-fill" viewBox="0 0 16 16">
                                    <path d="M10.5 8a2.5 2.5 0 1 1-5 0 2.5 2.5 0 0 1 5 0z"/>
                                    <path d="M0 8s3-5.5 8-5.5S16 8 16 8s-3 5.5-8 5.5S0 8 0 8zm8 3.5a3.5 3.5 0 1 0 0-7 3.5 3.5 0 0 0 0 7z"/>
                                </svg>
                            </a>
                            <a href="{{ route('brands.edit', ['brand' => $brand->id] )}}" class="btn btn-sm btn-outline-warning mb-0" data-toggle="tooltip" data-original-title="Edit user">
                            ...
                            <a href="{{ route('brands.status', ['id' => $brand->id] )}}" class="btn btn-sm btn-outline-success mb-0" data-toggle="tooltip" data-original-title="Edit user">
